...
project = u'googleapis-artman'
copyright = u'2016-2018 Google LLC'
...
distro = pkg_resources.get_distribution('googleapis-artman')
...
texinfo_documents = [
    ('index', 'googleapis-artman', u'googleapis-artman Documentation',
     author, 'googleapis-artman', 'Google APIs Artifact Manager.',
     'Miscellaneous'),
]
